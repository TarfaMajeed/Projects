        ...
        {[world, south, europe, caribbean].map((imgSrc, i) => (
          <div className="col-md-3" key={i}>
            <img
              ...
              onClick={() => {
                if (i === 0) navigate('/sea');  // Navigate on first image click
              }}
            />
          </div>
        ))}
  ...
  if (index === 0) navigate('/amestardam');
    ...
    />
                  ...
                  <div className="text-center my-2">
                    ...
                    <h4>Amsterdam Classic Saloon Boat Cruise, Drinks and Cheese Option</h4>
            ...
            <div className="row">
              {[img5, img6, img7, img8].map((img, index) => (
                <div className="col-md-3 position-relative" key={index + 4}>
                  ...
                  <div className="text-center my-2">
                    <h4>Anne Frank Garden Walking Tour Through Amsterdam's Jewish Quarter.</h4>
                    <div className="rating text-success">
                      <i className="bi bi-circle-fill"></i>
                      <i className="bi bi-circle-fill"></i>
                      <i className="bi bi-circle-fill"></i>
